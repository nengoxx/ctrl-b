...
- **The app IS this repo (ctrl-b v1.0)** — a mobile-first React/TS/Vite **PWA** backed by a
  ...
  **Doc map — read these before designing or implementing a feature:**
  ...
  | [`docs/VAPOR_ASSIMILATION_PLAN.md`](./docs/VAPOR_ASSIMILATION_PLAN.md) | Phase 16: vapor's COMPLETE migration onto the kit + cosmos default (**DRAFT 2026-07-31 — design NOT locked**; owner device round + council + D-entry pending). Amends THEME_ENGINE §14.15.3. |
