...
async def get_appearance(request: Request) -> dict[str, Any]:
    ...
    appbar_subtitle_visible, chat_avatars_visible, agent_backdrop, pwa_icon_background, updated_at}`
    (the M3 fields, the Kit Art System's shared-background switch, the app-bar brand-subtitle switch,
    the transcript-avatar switch and the agent-backdrop mode null until seeded).
