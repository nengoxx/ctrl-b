...
def _load_steps() -> tuple[Step, ...]:
    ...
    """
    from app.config_migration.steps import A11, LIVE_VOICE_D76, MEDIA_V2, PERSONAS_D78, PRESENCE_DEVICES

    return (A11, MEDIA_V2, PRESENCE_DEVICES, LIVE_VOICE_D76, PERSONAS_D78)
