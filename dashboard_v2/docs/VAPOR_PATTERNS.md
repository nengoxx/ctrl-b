...
`frontend/src/theme/vapor.css` (the verbatim lift of `ctrl-b (Vapor)/variations/vapor.html`) so new
...
`../../ctrl-b (Vapor)/variations/vapor.html`. The *why* behind it is in
`../../ctrl-b (Vapor)/chats/chat1..5.md` (the design back-and-forth) + that folder's `README.md`.
