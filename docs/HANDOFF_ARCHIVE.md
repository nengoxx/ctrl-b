...
> Verbatim history moved out of [`HANDOFF.md`](./HANDOFF.md) in the 2026-08-12 archive sweep
> (path 5 of the v1.6.0-close block). Contents: every session block in reverse-chronological
> order, 2026-08-12 ← 2026-05-28, plus the stale mid-build "Current state" section and the
