...
| **FE unit tests** | **Vitest** (D21 — 2,905 across 168 files, 2026-09-04 post-D2-C L2) | logic regressions | ✅ |
...
| **BE tests** | **pytest** (2,183 collected 2026-09-04 post-D2-C L1, temp-config safe — `conftest.py`: a module-level env guard that runs before any test module imports, plus the per-test autouse fixture; QH-10 + UPDATE_PLAN §3.7) | backend logic | ✅ |
