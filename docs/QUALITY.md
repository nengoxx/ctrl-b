...
| **FE unit tests** | **Vitest** (D21 — 2,245 across 144 files, 2026-08-24) | logic regressions | ✅ |
...
| **BE tests** | **pytest** (1,876 collected 2026-08-24, temp-config safe — `conftest.py`: a module-level env guard that runs before any test module imports, plus the per-test autouse fixture; QH-10 + UPDATE_PLAN §3.7) | backend logic | ✅ |
