...
| **FE unit tests** | **Vitest** (D21 — 2,252 across 144 files, 2026-08-25) | logic regressions | ✅ |
...
| **BE tests** | **pytest** (1,961 collected 2026-08-25, temp-config safe — `conftest.py`: a module-level env guard that runs before any test module imports, plus the per-test autouse fixture; QH-10 + UPDATE_PLAN §3.7) | backend logic | ✅ |
