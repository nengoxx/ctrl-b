...
| **FE unit tests** | **Vitest** (D21 — 2,922 across 169 files, 2026-09-06 post-D70 S4 Build 1: the agent-art resolver join, the who-line avatar swap + its Appearance switch, the picker avatars, `message.agent` on every TTS request) | logic regressions | ✅ |
