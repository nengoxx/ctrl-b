...
> export-beside-component trade). **No warning was fixed and no rule was touched; F13 stays
> trigger-gated.** Attributed here on the standing principle, in both directions.

Deferral status: all 100 stay in the F13 backlog. **This paragraph is the ONLY home for the
