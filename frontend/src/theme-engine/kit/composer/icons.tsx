...
/** Lucide `phone` — call mode's glyph. Graduated here from MicGestureChrome at its second consumer
 *  (the composer button itself, owner ask 2026-09-21: the mode flip has to be visible ON the button,
 *  not only in the accessible name). Stroke 2 like the rail's original; the mic's 2.6 turns this
 *  glyph's tight receiver curl into a blob at button sizes. */
