...
// self-subscribe to `store/composerOverlay` (open state), `store/composerSkills` (the ticked skills) and,
// for the panel, `store/chat`'s agent pins — so the slot identities stay stable across renders and
// dropping them in needs no wiring.
